...
-(NSArray *)imageArray
{
    if (!_imageArray)
    {
        UIImage *image1 = [UIImage imageNamed:@"fun_loading_1"];
        UIImage *image2 = [UIImage imageNamed:@"fun_loading_2"];
        UIImage *image3 = [UIImage imageNamed:@"fun_loading_3"];
        UIImage *image4 = [UIImage imageNamed:@"fun_loading_4"];
...
//            _statusLabel.text = MJRefreshHeaderReleaseToRefresh;
            ...
            [UIView animateWithDuration:MJRefreshAnimationDuration animations:^{
                ...
                _arrowImage.animationImages = self.imageArray;
                
                _arrowImage.animationDuration = 1/2;
...
//            _statusLabel.text = MJRefreshHeaderRefreshing;
            ...
            _arrowImage.animationDuration = 2;
