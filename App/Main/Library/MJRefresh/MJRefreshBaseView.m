...
//        arrowImage.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        UIImageView *imageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"fun_loading_1"]];
        
        
        [self addSubview:_arrowImage = imageView];
...
//			_arrowImage.hidden = YES;
            _arrowImage.image = [UIImage imageNamed:@"fun_loading_2"];
